...
oParser.add_option("-k", "--fieldDelim", default="|", dest="fieldDelim", help="field delimiter. [Default: %default]")
oParser.add_option("-f", "--keyField", default="1", dest="keyField", help="field to key on for 2d histogram. [Default: %default]")
...
header = ["KEY", "BIN", "FREQ", "BIN_%", "CUME", "1-CUME"]
